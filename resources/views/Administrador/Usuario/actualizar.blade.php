...
<script type="text/javascript">
    ...
    function eliminar(){
        ...
        var data={id_direccion:id_eliminar,_token:token};
    ...
    function ingresar()
    {
        ...
        console.log(id_usuario+' '+persona_recibe+" "+colonia+" "+calle+" "+numero_interior+"  "+numero_exterior+" "+cp+" "+
                ...
                var token = '{{csrf_token()}}';
        var data={id_usuario:id_usuario,persona_recibe:persona_recibe,colonia:colonia,calle:calle,numero_interior:numero_interior,numero_exterior:numero_exterior,cp:cp,referencia:referencia,calleA:calleA,calleB:calleB,telefono:telefono,_token:token};
...
modal.find('#eli').val(eliminado)
    ...
    function actualizar()
    {
        ...
        console.log(id_usuario+' '+persona_recibe+" "+colonia+" "+calle+" "+numero_interior+"  "+numero_exterior+" "+cp+" "+
                ...
                var token = '{{csrf_token()}}';
        var data={id_usuario:id_usuario,id_direccion:id_direccion,persona_recibe:persona_recibe,colonia:colonia,calle:calle,numero_interior:numero_interior,numero_exterior:numero_exterior,cp:cp,referencia:referencia,calleA:calleA,calleB:calleB,telefono:telefono,eliminado:eliminado,_token:token};
